...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('css/admin/addNewCategory.css') ?>">
        ...
        <div class="row signup-row" style="display: flex; flex-wrap: wrap">
            <div class="col-sm-12 col-md-3 panel">
                <div class="container-fluid">
                    ...
                    <div class="row" style="background-color:#1E272E;"> <a href="<?= base_url('addNewCategoryPage') ?>"> Add New Category </a> </div>
            ...
            <div class="col-sm-12 col-md-9 main-content">
                <div id="title"> Add New Category </div>
                <div>
                <form action="<?= base_url('addNewCategory') ?>" method="POST">
                    <div>
                        <input type="text" name="cat_name" placeholder="Enter Category Name">
                    </div> <br> <br>
                    <button type="submit" id="signup_button"> Add New Category</button>
                </form>
                </div>
            </div>
            </div>
