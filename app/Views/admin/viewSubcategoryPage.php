...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('css/admin/viewSubcategory.css') ?>">
        ...
        <div class="row signup-row" style="display: flex; flex-wrap: wrap">
            <div class="col-sm-12 col-md-3 panel">
                <div class="container-fluid">
                    ...
                    <div class="row" style="background-color:#1E272E;"> <a href="<?= base_url('viewSubcategoryPage') ?>"> View Subcategories </a> </div>
            ...
            <div class="col-sm-12 col-md-9 main-content">
                ...
                <table class="table">
                    ...
                    <tbody style="background-color:white;">
                        <?php 
                            $allSubcategories=session('allsubcategories');
                        ...
                        ?>
                            <tr>
                                ...
                                <td> <?= $subcategory['is_deleted'] ?></td>
                                <td> <a href="<?= base_url('editSubcategoryPage') ?>/<?= session('subcategory')['subcategory_id'] ?>" style="color:blue;"> Edit </a> </td>
                            </tr>
                        <?php
                            }
                        ?>
