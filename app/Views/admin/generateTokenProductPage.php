...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('css/admin/generateTokenProduct.css') ?>">
        ...
        <div class="row signup-row" style="display: flex; flex-wrap: wrap">
            <div class="col-sm-12 col-md-3 panel">
                <div class="container-fluid">
                    ...
                    <div class="row" style="background-color:#1E272E;"> <a href="<?= base_url('generateTokenProductPage') ?>"> Generate API Token for specific Product </a> </div>
                </div>
            </div>
            <div class="col-sm-12 col-md-9 main-content">
                <div id="title"> Generate Product API token </div>
                <div>
                    <form action="<?= base_url('generateTokenProduct') ?>" method="POST">
                        <div>
                        ...
                        <div>
                            <input type="text" name="token" placeholder="" id="token">
                        </div> <br>
                        <span style="font-weight: bolder; color:white;padding-left:2%;"> Expires On </span>
                        <div>
                            <input type="date" name="expiry_date">
                        </div> <br>
                        <button type="submit" id="signup_button"> Add Product API Token</button>
                    </form>
                </div>
            </div>
        </div>
