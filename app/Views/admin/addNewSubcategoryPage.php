...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('css/admin/addNewSubcategory.css') ?>">
        ...
        <div class="row signup-row" style="display: flex; flex-wrap: wrap">
            <div class="col-sm-12 col-md-3 panel">
                <div class="container-fluid">
                    ...
                    <div class="row" style="background-color:#1E272E;"> <a href="<?= base_url('addNewSubcategoryPage') ?>"> Add New Subcategory</a> </div>
            ...
            <div class="col-sm-12 col-md-9 main-content">
                <div id="title"> Add New Subcategory </div>
                <div>
                <form action="<?= base_url('addNewSubcategory') ?>" method="POST">
                    <div>
                        <input type="text" name="subcat_name" placeholder="Enter Subcategory Name">
                    </div>
                    <div>
                        <input type="text" name="category" placeholder="Enter Category Id">
                    </div>  
                    <br> <br>
                    <button type="submit" id="signup_button"> Add New Subcategory</button>
                </form>
                </div>
            </div>
            </div>
