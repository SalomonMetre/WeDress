...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('css/admin/viewCategory.css') ?>">
                    ...
                    <tbody style="background-color:white;">
                        ...
                        ?>
                            <tr>
                                ...
                                <td> <a href="<?= base_url('editCategoryPage') ?>/<?= session('category')['category_id'] ?>" style="color:blue;"> Edit </a> </td>
                            </tr>
                        <?php
                            }
                        ?>
