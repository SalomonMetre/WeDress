...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('css/admin/editSubcategory.css') ?>">
    ...
    <div class="container-fluid">
        ...
        <div class="row signup-row" style="display: flex; flex-wrap: wrap">
            ...
            <div class="col-sm-12 col-md-9 main-content">
                <div id="title"> Edit Subcategory </div>
                    <div>
                    <form action="<?= base_url('editSubcategory') ?>/<?= session('subcategory')['subcategory_id'] ?>" method="POST">
                        <div>
                            <label for="subcat_name">Subcategory Name</label>
                            <input type="text" name="cat_name" value="<?= session('subcategory')['subcategory_name'] ?>">
                        </div>
                        <div>
                            <label for="category">Category </label>
                            <input type="text" name="category" value="<?= session('subcategory')['category'] ?>">
                        </div>  
                        <div>
                        ...
                        <button type="submit" id="signup_button"> Edit Subcategory</button>
                    </form>
                    </div>
                </div>
        </div>
