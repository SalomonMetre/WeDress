...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('css/admin/editCategory.css') ?>">
        ...
        <div class="row signup-row" style="display: flex; flex-wrap: wrap">
            ...
            <div class="col-sm-12 col-md-9 main-content">
                <div id="title"> Edit Category </div>
                    <div>
                    <form action="<?= base_url('editCategory') ?>/<?= session('category')['category_id'] ?>" method="POST">
                        <div>
                            <label for="cat_name">Category Name</label>
                            <input type="text" name="cat_name" value="<?= session('category')['category_name'] ?>">
                        </div> 
                        <div>
                        ...
                        <button type="submit" id="signup_button"> Edit Category</button>
                    </form>
                    </div>
                </div>
        </div>
