...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('css/api/home.css') ?>">
    ...
    <div class="container-fluid">
        ...
        <div class="row signup-row" style="display: flex; flex-wrap: wrap">
            <div class="col-sm-12 col-md-3 panel">
                <div class="container-fluid">
                    <div class="row" style="background-color:#1E272E;"> <a href="<?= base_url('apiHomePage') ?>"> Introduction </a> </div>
            ...
            <div class="col-sm-12 col-md-9 main-content">
                ...
                <p style="color: orange; font-size:18px;"> This API documentation provides you with the necessary guidance for you to call and consume data from our API using specific API access keys and/or tokens. The data you receive will be in <span style="color: palegreen; font-family:'Courier New', Courier, monospace"> JSON format. </span> </p> <br> <br>
